...
class SoftwaresControllerTest < ActionController::TestCase
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post :create, software: { item_id: @software.item_id, name: @software.name, notes: @software.notes, serial: @software.serial }
    end
  ...
  test "should update software" do
    patch :update, id: @software, software: { item_id: @software.item_id, name: @software.name, notes: @software.notes, serial: @software.serial }
    assert_redirected_to software_path(assigns(:software))
  end
